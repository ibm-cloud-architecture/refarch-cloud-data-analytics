...
>  
> **Note**  
> If you need help with the prerequisites, go to the the [Prereq Step by Step Directions](https://github.com/ibm-cloud-architecture/refarch-cloud-data-analytics/blob/master/PreWork.md)
>  
