...
1. Enter the Host name from your dashDB service credentials you obtained in the prework exercise [link](https://github.com/ibm-cloud-architecture/refarch-cloud-data-analytics/blob/master/PreWork.md#step-d-create-the-dashdb-credentials).
